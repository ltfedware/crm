...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="/customer/list.shtml" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<div>
								<a href="/customer/list.shtml?currenpage=${page.upper}&custName=${dataMap.custName}&custSource=${dataMap.custSource}&custIndustry=${dataMap.custIndustry}&custLevel=${dataMap.custLevel}">上页</a>
								<c:forEach begin="${page.lpage}" end="${page.rpage}" var="pg">
									<a href="/customer/list.shtml?currenpage=${pg}&custName=${dataMap.custName}&custSource=${dataMap.custSource}&custIndustry=${dataMap.custIndustry}&custLevel=${dataMap.custLevel}">${pg}</a>
								</c:forEach>
								<a href="/customer/list.shtml?currenpage=${page.next}&custName=${dataMap.custName}&custSource=${dataMap.custSource}&custIndustry=${dataMap.custIndustry}&custLevel=${dataMap.custLevel}">下页</a>
							</div>
						</div>
						<!-- /.panel-body -->
					</div>
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("/customer/update.shtml",$("#edit_customer_form").serialize(),function(data){
				alert("客户信息更新成功！");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("/customer/delete.shtml",{"id":id},function(data){
					alert("客户删除更新成功！");
					window.location.reload();
				});
			}
